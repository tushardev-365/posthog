...
class TestGetRecentReports(BaseTest):
    ...
    def test_scoped_to_all_source_products_except_pulse(self) -> None:
        ...
        # Anti-amplification: every source product feeds briefs except pulse's own output.
